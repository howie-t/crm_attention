...
# EEG Triggers
USE_EEG = False
TRIG_BLOCK_COND_0_START = 0
TRIG_BLOCK_COND_0_END = 1
TRIG_BLOCK_COND_1_START = 2
TRIG_BLOCK_COND_1_END = 3
TRIG_STIM_ON_LEFT = 4
TRIG_STIM_OFF_LEFT = 5
TRIG_STIM_ON_RIGHT = 6
TRIG_STIM_OFF_RIGHT = 7
TRIG_STIM_ON_NO_TARGET = 8
TRIG_STIM_ON_NO_TARGET = 9
TRIG_RESPONSE_LEFT = 10
TRIG_RESPONSE_RIGHT = 11
